 ...
 */
open class SendTransactionFlow(val otherSide: Party, private val payload: Any?) : FlowLogic<Unit>() {
    @Suspendable
    protected open fun sendPayloadAndReceiveDataRequest(payload: Any?) = payload?.let {
